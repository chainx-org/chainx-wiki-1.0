...
2. 点击创建账户，生成节点账户，**账户地址**形如 `5HbT8...S9yg`，导出**账户私钥**形如 `0x30530...c95aee43`。
    ...
    1. **请注意右上角点击设置按钮后,网络类型为"主网预演(主网预发布)"状态**
    <img width="421" alt="img" src="https://user-images.githubusercontent.com/5023721/57748085-fd9fd700-770a-11e9-9856-36aa8c1cc258.png">

    2. 选择节点管理的添加节点,添加节点地址
